...
add_action( 'admin_init', 'register_gf_disable_autofill' );
...
function register_gf_disable_autofill() {
  add_action( 'wp_enqueue_scripts', 'register_gfdaa_scripts' );
  add_filter( 'plugin_action_links_' . plugin_basename(__FILE__), 'gf_disable_autofill_action_links' );
}
